...
% - Optional external EconML discussion for CausalForestDML
% - Optional Best linear predictor discussion
...
\begin{itemize}
    ...
    \item Discuss CausalForestDML as optional external-package methodology
    \item Discuss the Best Linear Predictor (BLP) for effect heterogeneity
...
\begin{enumerate}
    ...
    \item \textbf{CausalForestDML}: Optional external-package method for non-parametric heterogeneity
    \item \textbf{BLP}: Optional linear summary of heterogeneity for interpretation and testing
    \item \textbf{Policy trees}: Optional rules for treatment targeting
\end{enumerate}
...
\begin{itemize}
    ...
    \item CausalForestDML is discussed through EconML, not implemented in this repo
    ...
    \item Policy trees are deferred optional work for this companion repo
\end{itemize}
}
