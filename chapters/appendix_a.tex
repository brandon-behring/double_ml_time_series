...
Translate the HAC standard error computation from Chapter 5 (\texttt{temporalcv}'s \texttt{hac} module, used by the companion) to Julia. Verify numerical equivalence with the Python implementation on test data.
\end{exercise}
