% Chapter 10: Research Pipeline Utilities for Causal Inference
% ============================================================================
% This chapter covers:
% - Why deployed causal inference differs from standard ML
...
% - Research pipeline utility structure
% ============================================================================

\chapter{Research Pipeline Utilities for Causal Inference}
\label{ch:production}
...
\begin{itemize}
    \item Understand why deployed causal inference differs from standard ML
    \item Design model serialization for DML's two-stage architecture
    \item Sketch inference API contracts for treatment effect estimation
    ...
    \item Assemble reproducible research/demo pipelines
\end{itemize}
}
...
\begin{itemize}
    ...
    \item \textbf{Promotion}: Candidate $\rightarrow$ active workflow
    \item \textbf{Rollback}: Revert to previous active version
...
\section{End-to-End Research Pipeline}\label{sec:production_pipeline}
...
\end{tikzpicture}
\caption{Research DML pipeline architecture}
...
\textbf{Key Takeaways:}
\begin{itemize}
    \item Deployed causal inference \textbf{cannot monitor treatment effect accuracy} directly
    ...
    \item End-to-end research pipelines can organize monitoring, versioning, and orchestration concepts
\end{itemize}
}

The companion ``dml\_ts.production`` module currently provides demo utilities:
\begin{itemize}
