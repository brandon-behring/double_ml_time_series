...
\begin{lstlisting}[language=Python, caption={DML model version structure}]
@dataclass
...
\begin{lstlisting}[language=Python, caption={Model registry workflow}]
# Initialize registry
...
\begin{lstlisting}[language=Python, caption={CATE estimation API}]
...
\begin{lstlisting}[language=Python, caption={CATE response structure}]
@dataclass
class CATEResponse:
...
\begin{lstlisting}[language=Python, caption={Overlap monitoring}]
...
\begin{lstlisting}[language=Python, caption={Treatment shift monitoring}]
...
\begin{lstlisting}[language=Python, caption={Nuisance degradation monitoring}]
...
\begin{keyinsight}[Why We Monitor Nuisance $R^2$, Not Effect Accuracy]
...
\begin{lstlisting}[language=Python, caption={Effect stability monitoring}]
...
\begin{lstlisting}[language=Python, caption={Retraining scheduler}]
...
\begin{lstlisting}[language=Python, caption={Trigger type enumeration}]
...
\section{End-to-End Pipeline}\label{sec:complete_pipeline}
...
\begin{lstlisting}[language=Python, caption={Complete production pipeline}]
...
\begin{lstlisting}[language=Python, caption={Airflow DAG skeleton}]
...
\begin{lstlisting}[language=Python, caption={Insurance pipeline configuration}]
...
\begin{lstlisting}[language=Python, caption={Training with monitoring}]
# Load data
...
\begin{lstlisting}[language=Python, caption={Production inference}]
