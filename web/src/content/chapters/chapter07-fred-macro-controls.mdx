...
source_sha256: c2dfc970f38ece01416c361d288889a900ec2090858333876e3b80aac415e986
provenance:
  ai_tools:
    - Claude Code
  audit_history:
...
The Federal Reserve Bank of St. Louis maintains FRED (Federal Reserve Economic Data), containing over 800,000 time series. Our `FREDLoader` class in `src/data/fred_loader.py` provides standardized access.
...
from src.dml import TemporalPLRDML, PanelDML
import numpy as np
