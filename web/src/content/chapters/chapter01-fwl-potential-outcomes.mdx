...
source_file: chapters/chapter_01.tex
source_sha256: a5c0bf8b85fcbda22c5773cbe980623f36b07e46857a0ba39a917438cdcf9f2e
# v4.8.0 provenance — references only files that exist in this repo. DML's audit
# substrate is a single repo-quality + methodology pass; no DECISIONS.md / sessions
# / research-kb here, so citation_backstop / prompts_archive / decisions_log are omitted.
provenance:
  ai_tools:
    - Claude Code
  audit_history:
