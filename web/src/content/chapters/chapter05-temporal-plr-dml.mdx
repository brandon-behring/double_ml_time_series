...
source_sha256: 71712e7ad7085dc7d84edfafd1454c6a4ed7bf6849b7050e95fa23f467752297
provenance:
  ai_tools:
    - Claude Code
  audit_history:
...
We implement three strategies in `src/dml/cross_fitting.py`:
...
Three commonly used kernels (implemented in `src/dml/hac.py`):
...
```python
from src.dml import HACEstimator, newey_west_se
