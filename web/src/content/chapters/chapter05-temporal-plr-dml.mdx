...
source_sha256: 9dbab79dd43c4961e97d115729ec538526cf4fbb98fa33ee95d15083839dd348
provenance:
  ai_tools:
    - Claude Code
  audit_history:
...
Three commonly used kernels (implemented in `dml_ts/dml/hac.py`):
...
The rule-of-thumb bandwidth for the Bartlett kernel:
...
(a) Calculate the rule-of-thumb bandwidth $B^* = \lfloor 1.3 \cdot n^{1/3} \rfloor$.
(b) Calculate the Andrews data-driven bandwidth.
(c) Which would you recommend and why?

**Solution.**

(a) $B^* = \lfloor 1.3 \times 1000^{1/3} \rfloor = \lfloor 1.3 \times 10 \rfloor = 13$.
